...
export default function TestimonialCard({ 
  ...
  return (
    <div className="w-full bg-white rounded-xl shadow-lg overflow-hidden p-6 flex flex-col gap-4 border border-border/20 hover:shadow-xl transition-shadow duration-300">
      ...
      {/* Review Text */}
      <p className="text-gray-700 leading-relaxed whitespace-pre-line line-clamp-4">{text}</p>
    </div>
  );
}
