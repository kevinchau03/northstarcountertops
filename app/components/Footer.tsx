                ...
                <div className="flex flex-col items-center text-center lg:justify-between w-full p-6 lg:flex-row gap-4">
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center gap-2 lg:gap-4">
                        <p className="text-sm text-secondary">
                            Copyright &copy; 2025 Northstar Countertops. All Rights Reserved.
                        </p>
                        <div className="hidden lg:block w-1 h-1 bg-secondary rounded-full"></div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <a 
                            href="https://www.facebook.com/NSCountertops/" 
                            target="_blank" 
                        ...
                        <a 
                            href="https://www.instagram.com/nscountertop/?hl=en" 
                            target="_blank"
                            rel="noopener noreferrer"
                            className="group flex items-center justify-center p-2 rounded-lg hover:bg-primary/10 transition-all duration-200"
